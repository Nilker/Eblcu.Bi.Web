...
using Eblcu.Bi.Web.Authentication.TwoFactor;
using Eblcu.Bi.Web.Configuration;
#if FEATURE_SIGNALR
...
namespace Eblcu.Bi.Web
{
    ...
    public class BiWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BiWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BiWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(BiWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
