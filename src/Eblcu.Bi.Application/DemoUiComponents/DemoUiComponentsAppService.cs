...
using Eblcu.Bi.DemoUiComponents.Dto;

namespace Eblcu.Bi.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : BiAppServiceBase, IDemoUiComponentsAppService
    {
