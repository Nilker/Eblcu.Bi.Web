...
namespace Eblcu.Bi.Web.Public.Startup
{
    ...
    public class BiWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public BiWebFrontEndModule(IHostingEnvironment env, BiEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BiWebFrontEndModule).GetAssembly());
        }
    }
}
