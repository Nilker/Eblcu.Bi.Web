...
using Eblcu.Bi.Authorization.Users.Profile;
using Eblcu.Bi.Authorization.Users.Profile.Dto;
using Eblcu.Bi.Commands;
...
namespace Eblcu.Bi.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Bi";
