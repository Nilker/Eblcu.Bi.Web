...
namespace Eblcu.Bi.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : BiServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Eblcu.Bi", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
