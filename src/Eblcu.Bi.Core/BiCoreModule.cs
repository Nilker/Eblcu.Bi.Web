...
using Eblcu.Bi.Debugging;
using Eblcu.Bi.Emailing;
using Eblcu.Bi.Features;
using Eblcu.Bi.Friendships;
using Eblcu.Bi.Friendships.Cache;
using Eblcu.Bi.Localization;
using Eblcu.Bi.MultiTenancy;
using Eblcu.Bi.MultiTenancy.Payments.Cache;
...
namespace Eblcu.Bi
{
    ...
    public class BiCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            BiLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = BiConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<BiSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
            ...
            {
                cache.DefaultSlidingExpireTime = TimeSpan.FromMinutes(BiConsts.PaymentCacheDurationInMinutes);
            });
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(BiCoreModule).GetAssembly());
        }
